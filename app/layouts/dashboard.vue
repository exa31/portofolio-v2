...
<template>
  <div class="flex min-h-screen bg-[#0a0f1a]">
    <!-- Sidebar -->
    <aside class="w-64 bg-[#0f1520] border-r border-white/10 flex flex-col">
      <!-- Logo -->
    ...
    <div class="flex-1 flex flex-col">
      <!-- Top Navigation Bar -->
      <header class="h-16 border-b border-white/10 bg-[#0f1520] flex items-center px-8">
        <div class="flex-1 flex items-center gap-4">
          <div class="flex items-center gap-2 text-white/50 text-sm">
            ...
            <Icon name="carbon:chevron-right" size="16"/>
